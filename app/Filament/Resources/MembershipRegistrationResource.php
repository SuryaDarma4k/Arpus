...
use App\Filament\Resources\MembershipRegistrationResource\Pages;
use App\Filament\Resources\MembershipRegistrationResource\RelationManagers;
...
class MembershipRegistrationResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'create' => Pages\CreateMembershipRegistration::route('/create'),
            'edit' => Pages\EditMembershipRegistration::route('/{record}/edit'),
        ];
    }
}

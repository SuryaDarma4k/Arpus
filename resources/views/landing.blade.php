...
<body class="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900">
    <div class="main-wrapper">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div class="animate-fade-in-up">
                        ...
                        <p class="text-2xl text-indigo-100 mb-12 max-w-4xl mx-auto leading-relaxed">
                            Platform digital revolusioner yang menghadirkan pengalaman pengelolaan arsip dan
                            perpustakaan
                            dengan
                            teknologi canggih.
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-20 max-w-4xl mx-auto">
                        <div class="glass-effect rounded-3xl p-8 card-hover animate-fade-in-left">
                            ...
                            <div class="w-full bg-white/20 rounded-full h-2 mt-4">
                                <div
                                    class="bg-gradient-to-r from-cyan-400 to-blue-600 h-2 rounded-full w-3/4 animate-pulse">
                                </div>
                            </div>
                        </div>
                        <div class="glass-effect rounded-3xl p-8 card-hover animate-fade-in-right">
                            ...
                            <div class="w-full bg-white/20 rounded-full h-2 mt-4">
                                <div
                                    class="bg-gradient-to-r from-purple-400 to-pink-600 h-2 rounded-full w-2/3 animate-pulse">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <section id="services" class="relative py-24 bg-gradient-to-b from-white/5 to-transparent">
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="text-center mb-16 animate-fade-in-up">
                        ...
                        <p class="text-2xl text-indigo-200 max-w-4xl mx-auto">Akses koleksi digital dan layanan
                            perpustakaan
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="space-y-4 mb-8">
                                    <div class="flex items-center space-x-3 text-white">
                                        <div class="w-2 h-2 bg-gradient-to-r from-purple-400 to-pink-600 rounded-full">
                                        </div>
                        ...
                        <div
                            ...
                            <div class="relative z-10">
                                ...
                                <div class="space-y-4 mb-8">
                                    <div class="flex items-center space-x-3 text-white">
                                        <div class="w-2 h-2 bg-gradient-to-r from-cyan-400 to-blue-600 rounded-full">
                                        </div>
                ...
                <section id="dashboard" class="relative py-24 bg-gradient-to-b from-transparent to-white/5">
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <div class="text-center mb-16 animate-fade-in-up">
                            ...
                            <p class="text-2xl text-indigo-200 mb-8">Visualisasi data pengunjung perpustakaan dengan
                                teknologi
                                terdepan</p>
                    ...
                    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-10">
                            <div class="glass-effect rounded-3xl p-10 card-hover animate-fade-in-left shadow-2xl">
                                ...
                                <p class="text-indigo-200 text-lg leading-relaxed">Pantau statistik pengunjung dan
                                    peminjaman
                                    buku secara langsung dengan visualisasi data yang interaktif dan dashboard yang
                                    responsif.
                                </p>
                            </div>
                            ...
                            <div class="glass-effect rounded-3xl p-10 card-hover animate-fade-in-up shadow-2xl">
                                ...
                                <p class="text-indigo-200 text-lg leading-relaxed">Kelola ribuan koleksi buku dengan
                                    sistem
                            ...
                            <div class="glass-effect rounded-3xl p-10 card-hover animate-fade-in-right shadow-2xl">
                                ...
                                <p class="text-indigo-200 text-lg leading-relaxed">Sistem pendaftaran anggota
                                    terintegrasi
        ...
        <!-- Footer -->
        <footer class="bg-black/20 backdrop-blur-md border-t border-white/10 text-white py-16 mt-auto">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
                    <div class="animate-fade-in-left">
                        ...
                        <p class="text-indigo-200 leading-relaxed">Platform digital revolusioner untuk
                            manajemen
                            arsip
                            dan
                    ...
                    <div class="animate-fade-in-up">
                        ...
                        <ul class="space-y-3 text-indigo-200">
                            ...
                            <li><a href="#" class="hover:text-white transition-colors">Mobil Pintar</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="animate-fade-in-right">
                        ...
                        <div class="space-y-3 text-indigo-200">
                            <div class="flex items-center space-x-3">
                                ...
                                <span class="text-sm">Jl. Prof. Sudarto No.116 , Sumurboto , Kec. Banyumanik,
                                    Kota
                ...
                <div class="border-t border-white/20 mt-12 pt-8 text-center">
                    <p class="text-indigo-200">© 2025 Silver Arpus. Hak Cipta Dilindungi. Dikembangkan dengan
                        ❤️
                        untuk
                        masa
